...
<script lang="ts">
	...
	export let variant = 'default'; // 'default', 'outline'
...
<button
	...
	class={`
    inline-flex items-center justify-center gap-3 rounded-md font-medium
    transition-all duration-200 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none
    disabled:cursor-not-allowed disabled:opacity-50
    ${sizeClasses[size as keyof SizeClasses]}
    ${variantClasses[variant as keyof VariantClasses]}
  `}
>
	{#if loading}
		<!-- Loading spinner -->
